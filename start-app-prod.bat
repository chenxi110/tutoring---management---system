@echo off
chcp 936 >nul
title Shangketong - Production Mode

echo ============================================================
echo    Shangketong Tutoring Management System [PROD]
echo ============================================================
echo.
...
echo [START] Starting Spring Boot application [PRODUCTION MODE]...
...
echo [INFO] Production profile active: SQL logs and stack traces disabled
echo.
echo [TIP] Close this window to stop the app
echo.

java -Xms128m -Xmx512m -jar target\skt-server-1.0.0.jar --spring.profiles.active=prod
